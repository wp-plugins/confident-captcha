...
<div class="wrap">
   ...
   <form method="post" action="options.php">
      ...
      <p><?php _e('These keys are required before you are able to do anything else.', 'confidentCaptcha'); ?> <?php _e('You can get the keys', 'confidentCaptcha'); ?> <a href="www.confidenttechnologies.com" title="<?php _e('Get your confidentCaptcha API Keys', 'confidentCaptcha'); ?>"><?php _e('here', 'confidentCaptcha'); ?></a>.</p>
